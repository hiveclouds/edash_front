...
const HD_SERVER_EVENT_TO_KIND = {
    ...
    TICKET_COMMENT_ADDED: "server-ticket-comment",
};
...
function hdLocalizeNotif(entry) {
    ...
    // Komentar baru di tiket yang di-assign ke kamu -- lihat
    // notifyCommentAdded() di ticket.service.ts.
    if (entry.kind === "server-ticket-comment") {
        return {
            type: "info",
